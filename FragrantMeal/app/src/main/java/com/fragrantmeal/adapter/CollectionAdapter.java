...
public class CollectionAdapter extends BaseAdapter {
    ...
    public CollectionAdapter(Context context, List<Seller> sellers) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_collection_seller, null);
        ...
        viewHolder.llCollection.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(context, SellerDishActivity.class);
